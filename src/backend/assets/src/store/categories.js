...
export default {
    ...
    actions: {
        all ({state, commit, rootState}, params) {
            return Vue.axios.get('/content/api/v1/category/index', {params: params})
                .then(
        ...
        find ({state, commit, rootState}, id) {
            return Vue.axios.get('/content/api/v1/category/find', {params: {id: id}})
                .then(
        ...
        save ({state, commit, rootState}, model) {
            return Vue.axios.post('/content/api/v1/category/save', model)
                .then(
                    response => commit('FETCH_MODEL_SUCCESS', response.data),
                    error => {}
                )
        ...
        delete ({state, commit, rootState}, id) {
            return Vue.axios.post('/content/api/v1/category/delete', { id: id })
                .then(
